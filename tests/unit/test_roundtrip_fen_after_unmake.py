...
def test_roundtrip_quiet_move_fen() -> None:
...
def test_roundtrip_capture_fen() -> None:
    position = parse_fen("8/8/8/4p3/4R3/8/8/8 w - - 0 1")
    original_fen = position.to_fen()
...
def test_roundtrip_promotion_fen() -> None:
